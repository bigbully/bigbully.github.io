...
从这篇笔记开始，我打算尝试一下更丰富的md语法，用来让笔记更易读。顺便推荐一下StackEdit，很不错的在线MD编辑器。
...
st=>start: 提交任务
e=>end: 执行handler
op1=>operation: 创建核心线程，并执行任务
cond1=>condition: 核心线程是否创建?
cond2=>condition: 核心线程都在工作中?
op2=>operation: 使用核心线程执行任务
cond3=>condition: 队列是否已满
op3=>operation: 放入队列
cond4=>condition: 最大线程数>核心线程数？
op4=>operation: 使用handler策略处理任务
e=>end: 创建非核心线程处理任务
